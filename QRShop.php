...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="QRShop.php"><?php echo $GLOBALS['L']['menu_qrshop'] ?></a></li>
    ...
    <div class="container">
        <center>
            <h2 class="mb-2"><?php echo $GLOBALS['L']['about_qrshop'] ?></h2>
        </center>
        <br /><br />
        <p><?php echo $GLOBALS['L']['qrshop_intro_1'] ?></p>
        <p><?php echo $GLOBALS['L']['qrshop_intro_2'] ?></p>
    </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-5 pb-5">
                <div class="col-md-7 text-center heading-section ftco-animate">
                    <h2 class="mb-2">
                        <p><?php echo $GLOBALS['L']['qrshop_instruction'] ?>
                    </h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services d-block text-center">
                        ...
                        <div class="media-body p-2 mt-3">
                            <h3 class="heading"><?php echo $GLOBALS['L']['qrshop_download'] ?></h3>
                            <p><?php echo $GLOBALS['L']['qrshop_download_1'] ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services d-block text-center">
                        ...
                        <div class="media-body p-2 mt-3">
                            <h3 class="heading"><?php echo $GLOBALS['L']['qrshop_registered'] ?></h3>
                            <p><?php echo $GLOBALS['L']['qrshop_registered_1'] ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services d-block text-center">
                        ...
                        <div class="media-body p-2 mt-3">
                            <h3 class="heading"><?php echo $GLOBALS['L']['qrshop_scan'] ?></h3>
                            <p><?php echo $GLOBALS['L']['qrshop_scan_1'] ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services d-block text-center">
                        ...
                        <div class="media-body p-2 mt-3">
                            <h3 class="heading"><?php echo $GLOBALS['L']['qrshop_orders'] ?></h3>
                            <p><?php echo $GLOBALS['L']['qrshop_orders_1'] ?></h3>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services d-block text-center">
                        ...
                        <div class="media-body p-2 mt-3">
                            <h3 class="heading"><?php echo $GLOBALS['L']['qrshop_preparation'] ?></h3>
                            <p><?php echo $GLOBALS['L']['qrshop_preparation_1'] ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services d-block text-center">
                        ...
                        <div class="media-body p-2 mt-3">
                            <h3 class="heading"><?php echo $GLOBALS['L']['qrshop_takemeal'] ?></h3>
                            <p><?php echo $GLOBALS['L']['qrshop_takemeal_1'] ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 d-flex">
                    <div class="services-wrap">
                        <div class="heading-section mb-5 ftco-animate">
                            ...
                            <span class="subheading"><?php echo $GLOBALS['L']['qrshop_advantage_1'] ?></span>
                        </div>
                        <div class="list-services d-flex ftco-animate">
                            ...
                            <div class="text">
                                <h3><?php echo $GLOBALS['L']['qrshop_advantage_beneficial'] ?></h3>
                                <p><?php echo $GLOBALS['L']['qrshop_advantage_beneficial_1'] ?></p>
                                <p><?php echo $GLOBALS['L']['qrshop_advantage_beneficial_2'] ?></p>
                            </div>
                        </div>
                        <div class="list-services d-flex ftco-animate">
                            <div class="icon d-flex justify-content-center align-items-center">
                            ...
                            <div class="text">
                                <h3><?php echo $GLOBALS['L']['qrshop_advantage_quike'] ?></h3>
                                <p><?php echo $GLOBALS['L']['qrshop_advantage_quike_1'] ?></p>
                                <p><?php echo $GLOBALS['L']['qrshop_advantage_quike_2'] ?></p>
                            </div>
                        </div>
                        <div class="list-services d-flex ftco-animate">
                            <div class="icon d-flex justify-content-center align-items-center">
                            ...
                            <div class="text">
                                <h3><?php echo $GLOBALS['L']['qrshop_advantage_attractive'] ?></h3>
                                <p><?php echo $GLOBALS['L']['qrshop_advantage_attractive_1'] ?></p>
                                <p><?php echo $GLOBALS['L']['qrshop_advantage_attractive_2'] ?></p>
                            </div>
                        </div>
                    </div>
                </div>
