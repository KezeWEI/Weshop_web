        ...
        <section class="ftco-section ftco-services">
                ...
                <div class="row">
                    <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                        <div class="media block-6 services d-block text-center">
                            <div class="d-flex justify-content-center"><div class="icon" class="icon"><img src="images/qrshop1.png" height="150" width="150"></div></div>
                            <div class="media-body p-2 mt-3">
                                <h3 class="heading">1. Téléchargement</h3>
                                <p>Téléchargez l’application depuis Apple Store, Google Play ou Huawei AppGallery</p>
                            </div>
                        </div>      
                    </div>
                    <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                    ...
                    <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                        <div class="media block-6 services d-block text-center">
                            <div class="d-flex justify-content-center"><div class="icon" class="icon"><img src="images/qrshop3.png" height="150" width="150"></div></div>
                            <div class="media-body p-2 mt-3">
                                <h3 class="heading">3. Scannage</h3>
                                <p>Les clients scannent votre QR code pour regarder le menu et faire la commande</p>
                            </div>
                        </div>      
                    </div>
                    <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                        <div class="media block-6 services d-block text-center">
                            <div class="d-flex justify-content-center"><div class="icon"><img src="images/qrshop4.png" height="150" width="150"></div></div>
                            <div class="media-body p-2 mt-3">
                                <h3 class="heading">4.Validation</h3>
                                <p>Validez la commande et votre imprimante sort automatiquement les tickets</p>
                            </div>
                        </div>      
                    </div>
                    <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                        <div class="media block-6 services d-block text-center">
                            <div class="d-flex justify-content-center"><div class="icon"><img src="images/qrshop5.png" height="150" width="150"></div></div>
                            <div class="media-body p-2 mt-3">
                                <h3 class="heading">5. Préparation</h3>
                                <p>Le chef commence à préparer leur commande</p>
                            </div>
                        </div>    
                    </div>
                    <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                        <div class="media block-6 services d-block text-center">
                            <div class="d-flex justify-content-center"><div class="icon"><img src="images/qrshop6.png" height="150" width="150"></div></div>
                            <div class="media-body p-2 mt-3">
                                <h3 class="heading">6. Récupération</h3>
                                <p>Les clients récupèrent leur commande au comptoir sans attendre ou mangent sur place</p>
                            </div>
                        </div>      
                    </div>
                </div>
            ...
            <div class="container-wrap mt-5">
                <div class="row d-flex no-gutters">
                    <div class="col-md-6 img ftco-animate" style="background-image: url(images/avantage.png)">
                        <!--<img class="col-img-lft" src="images/avantage.png">-->
                    </div>
                    <div class="col-md-6 d-flex">
                        <div class="services-wrap">
                            <div class="heading-section mb-5 ftco-animate">
                                <h2 class="mb-2">Les avantages de QRshop</h2>
                                <span class="subheading">Commander avec QRshop. C’est facile !</span>
                            </div>
                            <div class="list-services d-flex ftco-animate">
                                <div class="icon d-flex justify-content-center align-items-center">
                                    <span><img class="icon" src="images/profitable.png"></span>
                                </div>
                                <div class="text">
                                    <h3>Profitable</h3>
                                    <p>Selon la situation actuelle, une augmentation du chiffre d'affaires de 10-20%.</p>
                                </div>
                            </div>
                            <div class="list-services d-flex ftco-animate">
                                <div class="icon d-flex justify-content-center align-items-center">
                                    <span><img class="icon" src="images/effectif.png"></span>
                                </div>
                                <div class="text">
                                    <h3>Effectif</h3>
                                    <p>Vos commandes seront passées jusqu'à 30% plus vite. La gestion de votre base de données clients sera plus facile.</p>
                                </div>
                            </div>
                            <div class="list-services d-flex ftco-animate">
                                <div class="icon d-flex justify-content-center align-items-center">
                                    <span><img class="icon" src="images/Attractif.png"></span>
                                </div>
                                <div class="text">
                                    <h3>Attractif</h3>
                                    <p>Ce système intelligent de gestion client s’accompagne d’une carte de fidélité pour vous aider à fidéliser votre clientèle en plus d’attirer de nouveaux clients.</p>
                                </div>
                            </div>
                        </div>
                    </div>
