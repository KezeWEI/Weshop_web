        ...
        <div class="container-fluid">
            <div class="row no-gutters d-flex slider-text align-items-center justify-content-center" data-scrollax-parent="true">
                <div class="col-md-6 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                    ...
                    <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><?php echo $GLOBALS['L']['our_customer'] ?></h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
                    <div class="staff">
                        <div class="img mb-4" style="background-image: url(images/C_zhuge.png);" id="client1Image"></div>
                        <div class="info text-center">
                            ...
                            <div class="text">
                                <p id="client1Description">Un logiciel efficace et sécurisé, simple à utiliser, grâce à ce logiciel, nous avons gagné plus de temps à fidéliser nos nombreux clients pour augmenter nos chiffres d’affaires. Le service client est également très bon. Je le recommande vivement!</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
                    <div class="staff">
                        ...
                        <div class="info text-center">
                            ...
                            <div class="text">
                                <p id="client2Description">Nous avons travaillé avec ce logiciel depuis le début. Nombreuses fonctions sont disponibles avec une interface propre. Les services après-vente sont impeccables. les personnels sont très aimables et toujours à notre disposition en cas de problème.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
                    <div class="staff">
                        ...
                        <div class="info text-center">
                            ...
                            <div class="text">
                                <p id="client3Description">Logiciel avec utilisation flexible. L’accès aux chiffres d’affaires journaliers est facile. Les données sont présentées de façon ordonnée et claire, ce qui facilite la compréhension et la gestion de nos comptes. Abordable et vaut la peine d'être acheté.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
                    <div class="staff">
                        <div class="img mb-4" style="background-image: url(images/C_nouilles.png);" id="client4Image"></div>
                        <div class="info text-center">
                            ...
                            <div class="text">
                                <p id="client4Description">Ce logiciel nous a permis de gagner beaucoup de temps lors de la prise des commandes. Avec ce logiciel, nous n’avons plus besoin d’écrire les commandes en plusieurs fois ni de faire des aller-retour vers la cuisine. C’est vraiment très pratique!</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
                    <div class="staff">
                        <div class="img mb-4" style="background-image: url(images/C_sichuan.jpg);" id="client5Image"></div>
                        <div class="info text-center">
                            <h3><a id="client5Company">Saveurs de Sichuan</a></h3>
                            <span class="position" id="client5Address">54 Rue du Faurbourg Montmartre, 75009 Paris</span>
                            <div class="text">
                                <p id="client5Description"> La caisse développé par la société WEHSOP est vraiment très pratique car elle me permet de suivre mes statistiques de vente en temps réel. En tant que commerçants nous sommes écoutés, nos remarques sont prises en compte. Nous sommes très heureux avec notre choix. </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
                    <div class="staff">
                        ...
                        <div class="info text-center">
                            ...
                            <div class="text">
                                <p id="client6Description"> Simple d’utilisation car intuitive, la solution de logiciel de caisse enregistreuse proposée par WEHSOP, me correspond parfaitement. Elle m’a offert un gain de temps considérable, que ce soit dans ma comptabilité, dans ma gestion des stocks. </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
                    <div class="staff">
                        ...
                        <div class="info text-center">
                            ...
                            <div class="text">
                                <p id="client7Description"> Les fonctionnalités de cette solution de caisse enregistreuse m’ont permis de la facilité de mon travail, interconnecté avec ma caisse enregistreuse, et la gestion de fidélité de mes clients et ils permettent de me consacrer plus pleinement à mon métier.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
                    <div class="staff">
                        ...
                        <div class="info text-center">
                            ...
                            <span class="position" id="client8Address">229 Rue du Faubourg Saint Martin 75010 Paris</span>
                            <div class="text">
                                <p id="client8Description"> Nos serveurs passent beaucoup moins de temps à s’occuper de faire les commandes sur place, livraison ou emporté, et cette caisse est facile à surveiller mes chiffres d'affaire, l'interface peut être compris sans problème. </p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            if (lang == 'zh') {
                $.ajax({
                    ...
                    for (var i = 0; i < 8; i++) {
                        ...
                        $("#client" + clientNum + "Image").css('background-image', 'url(' + data_obj[i].imageUrl + ')')
                    }
                })
            } else {
                $.ajax({
