        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active"><a href="presentation.php" class="nav-link"><?php echo $GLOBALS['L']['menu_presentation'] ?></a></li>
        ...
        <div class="container-fluid">
            <div class="row no-gutters d-flex slider-text align-items-center justify-content-center" data-scrollax-parent="true">
                <div class="col-md-6 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                    ...
                    <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><?php echo $GLOBALS['L']['about_weshop'] ?></h1>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 d-flex align-items-center">
                            <div class="tab-pane fade show active" id="v-pills-whatwedo" role="tabpanel" aria-labelledby="v-pills-whatwedo-tab">
                                <div>
                                    <h2 class="mb-4"><?php echo $GLOBALS['L']['presentation_company'] ?></h2>
                                    <p><?php echo $GLOBALS['L']['presentation_company_1'] ?></p>
                                    <p><?php echo $GLOBALS['L']['presentation_company_2'] ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 ftco-animate p-md-5">
                    <div class="row">
                        ...
                        <div class="col-md-12 d-flex align-items-center">
                            <div class="tab-pane fade show active" id="v-pills-whatwedo" role="tabpanel" aria-labelledby="v-pills-whatwedo-tab">
                                <div>
                                    <h2 class="mb-4"><?php echo $GLOBALS['L']['presentation_task'] ?></h2>
                                    <p><?php echo $GLOBALS['L']['presentation_task_1'] ?></p>
                                    <p><?php echo $GLOBALS['L']['presentation_task_2'] ?></p>
                                </div>
                            </div>
                ...
                <div class="col-md-6 ftco-animate p-md-5">
                    <div class="row">
                        ...
                        <div class="col-md-12 d-flex align-items-center">
                            <div class="tab-pane fade show active" id="v-pills-whatwedo" role="tabpanel" aria-labelledby="v-pills-whatwedo-tab">
                                <div>
                                    <h2 class="mb-4"><?php echo $GLOBALS['L']['presentation_aims'] ?></h2>
                                    <p><?php echo $GLOBALS['L']['presentation_aims_1'] ?></p>
                                    <p><?php echo $GLOBALS['L']['presentation_aims_2'] ?></p>
                                    <p><?php echo $GLOBALS['L']['presentation_aims_3'] ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
